...
//#define USE_ETHERNET_SHIELD
  ...
  #error "Uncomment the #define for either USE_WIFI101_SHIELD or USE_ETHERNET_SHIELD"
    ...
    // Use WiFi
      ...
      #include <WiFi101.h>
    #endif
    char ssid[] = "Combine";    //  your network SSID (name) 
    char pass[] = "plasmakorv";   // your network password
...
void loop() {
  ...
  delay(300); // Note that the weather station only updates once a minute
}
