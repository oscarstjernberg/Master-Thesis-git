...
% Sum of total sugars kg/m^3
sum_sugars = (OG- 1000)/a;

% Glucose concentration, mol/m^3
G_0 = 12.61/142.3*sum_sugars/0.180156;
%G = 
% Maltose concentration, mol/m^3
M_0 = 13.692/142.3*sum_sugars/0.3423;
%M = 
% Maltotriose concentration, mol/m^3
N_0 = 116.205/143.2*sum_sugars/0.504437;
%N = 
...
% Surrounding temperature
T_s=12.5;
>>>>>>> 90a1ccbe9ecc2df426d1714efdf58692d911ced6
