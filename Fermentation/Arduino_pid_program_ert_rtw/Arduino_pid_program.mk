###########################################################################
## Makefile generated for Simulink model 'Arduino_pid_program'. 
## 
## Makefile     : Arduino_pid_program.mk
## Generated on : Wed Feb 14 15:11:16 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Arduino_pid_program.elf
...
PRODUCT_NAME              = Arduino_pid_program
MAKEFILE                  = Arduino_pid_program.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Alexander/Desktop/Master-Thesis-git/Fermentation
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Arduino_pid_program_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Arduino_pid_program.elf
...
DEFINES_ = -D_RTT_USE_SERIAL0_ -DMODEL=Arduino_pid_program -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Arduino_pid_program -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/Arduino_pid_program_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/Arduino_pid_program_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Arduino_pid_program_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
